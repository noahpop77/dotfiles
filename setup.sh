...
# Enforces stricter error handling. 
# TLDR: If a command fails the entire thing exits out immediately
set -euo pipefail
...
echo ""
echo -e "\033[32m--- Setup complete!\033[0m" # Prints the text within in green
